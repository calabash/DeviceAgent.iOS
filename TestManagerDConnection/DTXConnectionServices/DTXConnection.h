...
@class DTXChannel, DTXMessageParser, DTXMessageTransmitter, DTXResourceTracker, DTXTransport, NSArray, NSDictionary, NSMutableDictionary, NSString, DTXProxyChannel;
@protocol DTXBlockCompressor, DTXRateLimiter, OS_dispatch_queue, OS_dispatch_semaphore;

typedef void(^proxyHandler)(DTXProxyChannel *chan);
