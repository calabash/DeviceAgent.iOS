...
- (void)gestureSwipeWithDeltaVector:(CGVector)arg1 atOffset:(double)arg2 duration:(double)arg3;
- (id)initForEventStream:(id)arg1 frame:(CGRect)arg2 speed:(double)arg3;
