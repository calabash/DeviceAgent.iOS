...
@protocol OS_dispatch_queue, XCTestManager_ManagerInterface, XCUIAXNotificationHandling, XCUIApplicationMonitor;
...
@property id <XCUIApplicationMonitor> applicationMonitor;
...
- (void)requestAutomationSessionForTestTargetWithPID:(NSInteger)arg1 preferredBackendPath:(id)arg2 isBridged:(BOOL)arg3 reply:(CDUnknownBlockType)arg4;
