...
@class NSArray, NSDictionary, NSNumber, NSString, NSUUID, XCAXAuditConfiguration, XCAccessibilityElement, XCTCapabilities, XCTScreenshotRequest, XCTSpindumpRequestSpecification, XCTImage, XCTSerializedTransportWrapper, XCElementSnapshot, XCAXAuditResultCollection, XCUIElementSnapshotRequestResult;
