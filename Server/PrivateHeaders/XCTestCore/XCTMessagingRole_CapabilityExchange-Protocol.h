...
@class NSArray, NSDictionary, NSNumber, NSString, NSUUID, XCAXAuditConfiguration, XCAccessibilityElement, XCTCapabilities, XCTScreenshotRequest, XCTSpindumpRequestSpecification, XCUIElementSnapshotRequestResult, XCTImage, XCTSerializedTransportWrapper, XCAXAuditResultCollection;
