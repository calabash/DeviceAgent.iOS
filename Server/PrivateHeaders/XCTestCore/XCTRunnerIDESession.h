...
@protocol OS_dispatch_queue, NSObject, XCTRunnerIDESessionDelegate, XCUIApplicationMonitor, XCTMessagingChannel_RunnerToIDE;
...
@property(retain) id <XCTMessagingChannel_RunnerToIDE, NSObject> IDEProxy;
